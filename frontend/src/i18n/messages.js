...
export const messages = {
  vi: {
    ...
    paymentReceipt: {
      ...
      closeAria: "Đóng hộp thoại",
      successMessage:
        "Thanh toán của bạn đã được xử lý thành công. Hợp đồng đã được khởi tạo và freelancer đã nhận được thông báo.",
      orderCodeLabel: "Mã đơn",
      copyTitle: "Sao chép mã đơn",
      copySuccess: "✓ Đã sao chép mã đơn vào bộ nhớ tạm",
      amountLabel: "Số tiền",
      methodLabel: "Phương thức thanh toán",
      statusLabel: "Trạng thái",
      dateLabel: "Ngày thanh toán",
      nextStepsTitle: "BƯỚC TIẾP THEO",
      nextStep1: "Hợp đồng đã được tạo và đang có hiệu lực",
      nextStep2: "Bạn có thể trao đổi trực tiếp với freelancer ngay bây giờ",
      nextStep3: "Tạo các cột mốc (milestone) để theo dõi tiến độ dự án",
      nextStep4: "Giải ngân khi freelancer hoàn thành từng cột mốc",
      downloadReceiptBtn: "Tải hoá đơn",
      ...
      methodFallback: "Chuyển khoản qua SePay",
      filenamePrefix: "hoa-don",
      download: {
        heading: "HOÁ ĐƠN THANH TOÁN",
        divider: "===============",
        orderCode: "Mã đơn",
        date: "Ngày",
        status: "Trạng thái",
        ...
        contractDetailsTitle: "CHI TIẾT HỢP ĐỒNG",
        contractId: "Mã hợp đồng",
        project: "Dự án",
        freelancer: "Freelancer",
        startDate: "Ngày bắt đầu",
        nextStepsTitle: "BƯỚC TIẾP THEO",
        nextStep1: "1. Hợp đồng đã được khởi tạo",
        nextStep2: "2. Bạn có thể trao đổi trực tiếp với freelancer",
        nextStep3: "3. Tạo các cột mốc để theo dõi tiến độ",
        nextStep4: "4. Giải ngân khi hoàn thành cột mốc",
        supportLine: "Liên hệ hỗ trợ: support@thuetoi.com",
      },
    },
    errors: {
      code: {
  ...
  en: {
    ...
    paymentReceipt: {
      ...
      copySuccess: "✓ Order code copied to clipboard",
      amountLabel: "Amount",
      methodLabel: "Payment Method",
      statusLabel: "Status",
      dateLabel: "Date",
      nextStepsTitle: "NEXT STEPS",
      nextStep1: "The contract has been created and is now active",
      nextStep2: "You can now communicate with the freelancer",
      nextStep3: "Create milestones to track project progress",
      nextStep4: "Release payment upon milestone completion",
      ...
      methodFallback: "Bank transfer via SePay",
      ...
      download: {
        ...
        nextStepsTitle: "NEXT STEPS",
        nextStep1: "1. The contract has been created",
        nextStep2: "2. You can now communicate with the freelancer",
        nextStep3: "3. Create milestones to track progress",
        nextStep4: "4. Release payment upon completion",
        supportLine: "For support, contact: support@thuetoi.com",
      },
    },
    errors: {
      code: {
