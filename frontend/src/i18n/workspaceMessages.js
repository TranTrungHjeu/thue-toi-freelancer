  ...
  vi: {
    ...
    projectsPage: {
      ...
      projectBids: {
        ...
        paymentGenerateError: "Chưa thể tạo thanh toán lúc này. Vui lòng thử lại sau.",
        ...
        openQrLink: "Mở mã QR",
        checkoutSuccess: "Đã tạo thanh toán. Quét mã hoặc chuyển khoản để hoàn tất.",
  ...
  en: {
    ...
    projectsPage: {
      ...
      projectBids: {
        ...
        paymentGenerateError: "We could not create this payment right now. Please try again.",
        ...
        openQrLink: "Open QR",
        checkoutSuccess: "Payment created. Scan the QR code or transfer to complete payment.",
