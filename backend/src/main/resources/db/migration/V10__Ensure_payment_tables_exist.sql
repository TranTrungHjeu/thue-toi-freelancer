-- Ensure payment tables exist even if older environments already passed version 7/8.
-- This migration is written to be safe on fresh DBs (CREATE TABLE IF NOT EXISTS).
